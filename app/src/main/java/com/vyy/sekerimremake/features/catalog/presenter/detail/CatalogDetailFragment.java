...
import com.vyy.sekerimremake.features.catalog.data.resources.Exercise;
import com.vyy.sekerimremake.features.catalog.data.resources.Hyperglycemia;
import com.vyy.sekerimremake.features.catalog.data.resources.Hypoglycemia;
...
public class CatalogDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private void setViewPagerAndIndicator() {
        binding.viewPagerCatalogItem.setAdapter(new CatalogDetailPagerAdapter(this, mImages));
