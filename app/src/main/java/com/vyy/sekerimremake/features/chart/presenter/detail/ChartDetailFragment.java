...
public class ChartDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private void setListeners() {
        ...
        OnFocusChangeListenerInsulinLimits onFocusChangeListenerInsulinLimits;
        Resources resources = getResources();
        int minValue = resources.getInteger(R.integer.min_measurement_value);
        for (int i = 0; i < editTexts.length; i++) {
            editTexts[i].setFilters(inputFilters);
            if (i == 0 || i == 2 || i == 4) {
                onFocusChangeListenerInsulinLimits = new OnFocusChangeListenerInsulinLimits(mContext,
                        minValue,
            ...
            editTexts[i].setOnFocusChangeListener(onFocusChangeListenerInsulinLimits);
        }
    }
