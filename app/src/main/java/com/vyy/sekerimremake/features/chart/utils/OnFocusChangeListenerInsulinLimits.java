...
public class OnFocusChangeListenerInsulinLimits implements View.OnFocusChangeListener {
    private final Context context;
    private final int min, low, high;

    public OnFocusChangeListenerInsulinLimits(Context context, int min, int low, int high) {
